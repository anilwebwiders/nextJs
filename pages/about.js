      ...
      <section class="contact-us-section">
          <div class="container-fluid">
              <div class="row">
                  <div class="col-lg-12">
                      <div class="about-fnm">
                          <div class="about-fnm-img">
                              <img src="/img1.png" alt=""/>
                          </div>
                          <div class="about-fnm-text">
                              <div class="about-fnm-text-container">
                                <h2 class="about-fnm__title">About Fnm</h2>
                                <h3 class="about-fnm__sub__title">Social Network Platform for People focused on Health and Wellness</h3>
                 ...
                 <div class="col-lg-12">
                  <div class="body-content">
                     <div class="body-content__top">
                       <h2 class="title">The Community Categories are:</h2>
                       ...
                       <h2 class="title">Types of Users</h2>
