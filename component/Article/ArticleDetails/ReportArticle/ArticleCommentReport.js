...
const ArticleCommentReport = ({ comment, toggle, modal }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const data = await postData(
      "adminApi/reports/article/comment/main",
      { comment_id: comment.article_comment_id, user_id: auth.user.user_id, msg },
      auth.token
    );
    setLoad(false);
