...
const StoryCommentReplyEdit = ({ toggle, modal, editData, getR_Comments }) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const postInfo = {
      sc_reply_id: editData.sc_reply_id,
      message: comment.commentTxt ? comment.commentTxt : editData.sc_reply_text,
    };
    const data = await patchData("storyApi/comment/edit/reply", postInfo, auth.token);
                        ...
                        <div className="article-comments-write mt-5">
                          ...
                          <form onSubmit={handleSubmit}>
                            <textarea
                              ...
                              defaultValue={editData.sc_reply_text}
...
export default StoryCommentReplyEdit;
