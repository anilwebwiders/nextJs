...
const StoryCommentReplyForm = ({
  ...
  const handleSubmit = async (e) => {
    ...
    if (replyComment.length >= 500)
      return dispatch(notifyError("Reply can not be more than 500."));
    ...
    const res = await postData(`storyApi/comment/reply`, post, auth.token);
...
export default StoryCommentReplyForm;
