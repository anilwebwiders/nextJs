...
const StoryCommentReport = ({ comment, toggle, modal }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const data = await postData(
      "adminApi/reports/story/comment/main",
      { comment_id: comment.story_comment_id, user_id: auth.user.user_id, msg },
      auth.token
    );
    setLoad(false);
...
export default StoryCommentReport;
